...
# Conexión a MongoDB local (localhost)
mongo_uri = 'mongodb://localhost:27017/'  # Para local; cambia a env var si quieres
...
if __name__ == '__main__':
    app.run(debug=True, host='0.0.0.0', port=5000)  # debug=True para local, host 0.0.0.0 para acceso en red